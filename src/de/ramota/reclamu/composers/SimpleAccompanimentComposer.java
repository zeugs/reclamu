 ...
 */
public class SimpleAccompanimentComposer extends AccompanimentComposer {

    public SimpleAccompanimentComposer(String name) {
        super(name);
    }
    ...
    protected AbstractTrack getAccompanimentTrack(String name, AbstractTrack masterTrack, Instrument instrument) {
        ...
        for (AbstractSequence refSequence: masterTrack.Sequences) {
            ...
            if (twister.nextInt(4) != 0 && refSequence.getParentSequence() != null) {
